...
wavefile { filename = "AODinstruct1KR.wav"; } adi1;
sound {
    wavefile adi1;
    attenuation = 0.2;
} aod1Instruction;
...
wavefile { filename = "AODinstruct2KR.wav"; } adi2;
sound {
    wavefile adi2;
    attenuation = 0.2;
} aod2Instruction;

wavefile { filename = "AODinstruct3KR.wav"; } adi3;
sound {
    wavefile adi3;
    attenuation = 0.2;
} aod3Instruction;

wavefile { filename = "AODinstruct4KR.wav"; } adi4;
sound {
    wavefile adi4;
    attenuation = 0.2;
} aod4Instruction;

wavefile { filename = "AODinstruct5KR.wav"; } adi5;
sound {
    wavefile adi5;
    attenuation = 0.2;
} aod5Instruction;
